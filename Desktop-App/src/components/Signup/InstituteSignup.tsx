...
export default function TeacherSignup() {
  ...
  return (
    <div className="InstituteSignup">
      <div className="LeftTab">
        <img src={require("../../Assets/Images/testimg6.png")} />
        <div className="LeftTabHeader">Let's facilitate students & teachers with TeachMe</div>
      ...
      <div className="RightTab">
        <div className="SignupBody">
          <div className="SignupHeader">Signup as an Institute</div>
